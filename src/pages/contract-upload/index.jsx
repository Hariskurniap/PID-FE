    ...
    const handleFormSubmit = async (data) => {
        ...
        try {
            ...
            setUploadErrors([
                {
                    type: 'upload',
                    message: 'Gagal mengunggah dokumen kontrak',
                        ...
                        <div className="flex items-center space-x-3 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-body text-muted-foreground">
                                    Upload Kontrak • Kelola dokumen kontrak dengan mudah
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        {currentStep === 'uploading' && (
                            <div className="text-center py-8">
                                ...
                                <p className="text-lg font-medium">Mengunggah kontrak...</p>
                        ...
                        {currentStep === 'error' && (
                            <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div>
                                        <h3 className="font-medium text-red-800">Gagal mengunggah kontrak</h3>
